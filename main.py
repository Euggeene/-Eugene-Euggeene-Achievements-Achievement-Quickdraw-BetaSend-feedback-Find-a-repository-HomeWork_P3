...
# A_enter = input("Введите через пробел элементы списка: ").split()
# A_num = list(map(int, A_enter))
# if len(A_num) != N:
#     print('Введенные элементы не соответствуют заявленному количеству N')
# else:
...
#     print('Введенные элементы не соответствуют заявленному количеству N')
# else:
#     X = int(input('Введите число X, близкое с которым необходимо найти в списке: '))
#     min = abs(X - A_num[0])
#     index = 0
#     for i in range(1, N):
#         count = abs(X - A_num[i])
